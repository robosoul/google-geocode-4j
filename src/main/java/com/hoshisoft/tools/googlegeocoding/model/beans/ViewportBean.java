...
public class ViewportBean extends BaseJSONBean {
    ...
    public boolean equals(Object obj) {
        ...
        ViewportBean other = (ViewportBean) obj;
        if (northEast == null) {
    ...
    public String toString() {
        ...
        builder.append("ViewportBean [northEast=").append(northEast);
        builder.append(", southWest=").append(southWest);
        builder.append("]");
